...
import {
  ...
  FaMapMarkerAlt, FaShoppingCart, FaUserCircle, FaRecycle, FaChartLine,
...
export default function HomePage() {
  return (
    <div className="bg-gray-50 min-h-screen font-sans">
      ...
      {/* ===== Hero Section ===== */}
      <main className="relative flex items-center justify-center h-[55vh] text-center text-white overflow-hidden">
        ...
        <div
          ...
          style={{
            ...
            filter: 'blur(6px)',
            transform: 'scale(1.1)', /* scale prevents blur edge bleed */
          }}
        ></div>
