...
import {
  ...
  FaMapMarkerAlt, FaShoppingCart, FaUserCircle, FaCog, FaTruck,
  FaDirections, FaClock, FaBatteryFull, FaSync, FaExclamationTriangle, FaPauseCircle
} from 'react-icons/fa';
    ...
    >
      ...
      {vehicle.status === 'Active' && (
        <div className="space-y-2 text-sm">
          <p className="flex items-center gap-2 text-gray-700"><FaMapMarkerAlt className="text-blue-500" /> <strong>Current:</strong> {vehicle.current}</p>
          <p className="flex items-center gap-2 text-gray-700"><FaDirections className="text-purple-500" /> <strong>Next:</strong> {vehicle.next}</p>
